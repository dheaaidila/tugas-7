		...
		<div class="header">
			...
			<div class="bottom-header">
				<div class="container">
					...
					<div class="logo">
						<a href="index.html"><img src="{{url('public')}}/images/logo.png" title="gaia" /></a>
					</div>
		...
		<div class="top-nav">
			<div class="container">
				...
				<ul>
					...
					<li><a href="/collection">Collections<span> </span></a></li>
					...
					<!-- Slideshow 4 -->
					    <div  id="top" class="callbacks_container">
					      <ul class="rslides" id="slider4">
					        <li>
					          <img class="img-responsive" src="{{url('public')}}/images/slide1.jpg" alt="">
					        ...
					        <li>
					          <img src="{{url('public')}}/images/slide1.jpg" alt="">
					           <div class="slider-caption">
					          	<h1>Beautiful & durable</h1>
					          		<p>Classically simple and beautifully elegant Hard wearing leather shoes and hand-made with heart </p>
					          </div>
			...
			<div class="container">
				<div class="col-md-4 top-grid text-center">
					<div class="top-grid-pic">
						<img src="{{url('public')}}/images/pic01.png" title="Boots" />
						<span>Boots</span>
					</div>
					<div class="top-grid-pic-info">
						<a href="single_page">Seeall</a>
					</div>
				</div>
				<div class="col-md-4 top-grid text-center">
					<div class="top-grid-pic">
						<img src="{{url('public')}}/images/pic02.png" title="Boots" />
						<span>Casual</span>
					</div>
					<div class="top-grid-pic-info">
						<a href="single_page">Seeall</a>
				...
				<div class="col-md-4 top-grid text-center">
					<div class="top-grid-pic">
						<img src="{{url('public')}}/images/pic03.png" title="Boots" />
						<span>Formal</span>
					</div>
					<div class="top-grid-pic-info">
						<a href="single_page">Seeall</a>
			...
			<div class="container">
					                ...
					                <div class="item">
					                	<div onclick="location.href='single_page';" class="product-grid">
											<div class="product-pic">
												<img src="{{url('public')}}/images/p1.jpg" title="Elliot Boots" />
											</div>
					                 ...
					                 <div class="item">
					                	<div onclick="location.href='single_page';" class="product-grid">
											<div class="product-pic">
												<img src="{{url('public')}}/images/p2.jpg" title="Elliot Boots" />
											</div>
											<div class="product-pic-info">
												<h3><a href="#">Elliot Boots</a></h3>
												<div class="product-pic-info-price-cart">
					                 ...
					                 <div class="item">
					                	<div onclick="location.href='single_page';" class="product-grid">
											<div class="product-pic">
												<img src="{{url('public')}}/images/p3.jpg" title="Elliot Boots" />
											</div>
											<div class="product-pic-info">
												<h3><a href="#">Elliot Boots</a></h3>
												<div class="product-pic-info-price-cart">
							 ...
							 <!-- start content_slider -->
						       <div id="owl-demo1" class="owl-carousel text-center">
					                <div class="item">
					                	<div onclick="location.href='single_page';" class="product-grid">
											<div class="product-pic">
												<img src="{{url('public')}}/images/p4.jpg" title="Elliot Boots" />
											</div>
											<div class="product-pic-info">
												<h3><a href="#">Elliot Boots</a></h3>
												<div class="product-pic-info-price-cart">
													<div class="product-pic-info-price">
														<span>Rp 370.000,00</span>
														<label> </label>
													</div>
													<div class="product-pic-info-cart">
														<a class="p-btn" href="#">Buy now</a>
					                 ...
					                 <div class="item">
					                	<div onclick="location.href='single_page';" class="product-grid">
											<div class="product-pic">
												<img src="{{url('public')}}/images/p5.jpg" title="Elliot Boots" />
											</div>
											<div class="product-pic-info">
												<h3><a href="#">Elliot Boots</a></h3>
												<div class="product-pic-info-price-cart">
					                 ...
					                 <div class="item">
					                	<div onclick="location.href='single_page';" class="product-grid">
											<div class="product-pic">
												<img src="{{url('public')}}/images/p6.jpg" title="Elliot Boots" />
											</div>
											<div class="product-pic-info">
												<h3><a href="#">Elliot Boots</a></h3>
												<div class="product-pic-info-price-cart">
				...
				<div class="col-md-3 bottom-grids-right">
					...
					<div class="shhiping text-center">
						<h2>Free Shipping</h2>
						<a href="#"><img src="{{url('public')}}/images/offer-pic.png" title="$250" /></a>
					</div>
				</div>
				<div class="clearfix"> </div>
			</div>
